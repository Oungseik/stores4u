<footer class="py-16 px-4 sm:px-6 lg:px-8 xl:px-12 border-t border-border bg-muted/30">
  <div class="max-w-7xl mx-auto">
    <div class="grid md:grid-cols-4 gap-12 mb-12">
      ...
      <div class="md:col-span-1">
        ...
        <p class="text-sm text-muted-foreground mb-6">
          AI-powered store management platform for modern SMEs. Manage inventory, process sales, and grow your business.
        </p>
        <!-- Social links -->
        <div class="flex items-center gap-4">
          <a href="#" class="w-9 h-9 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/80 transition-colors">
      ...
      <div>
        ...
        <ul class="space-y-3">
          ...
          <li><a href="#how-it-works" class="text-sm text-muted-foreground hover:text-foreground transition-colors">How It Works</a></li>
          <li><a href="/pricing" class="text-sm text-muted-foreground hover:text-foreground transition-colors">Pricing</a></li>
      ...
      <div>
        ...
        <ul class="space-y-3">
          <li><a href="#" class="text-sm text-muted-foreground hover:text-foreground transition-colors">Documentation</a></li>
          <li><a href="#" class="text-sm text-muted-foreground hover:text-foreground transition-colors">API Reference</a></li>
          <li><a href="#" class="text-sm text-muted-foreground hover:text-foreground transition-colors">Help Center</a></li>
    ...
    <div class="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
      <p class="text-sm text-muted-foreground">
        © 2024 Stores4U. All rights reserved.
      </p>
