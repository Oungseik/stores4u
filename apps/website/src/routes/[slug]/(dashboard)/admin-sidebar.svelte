          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/products`)}
              >
                {#snippet child({ props })}
                  <a
            ...
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/products/categories`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/products/categories`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/purchases/invoices`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/purchases/invoices`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
            ...
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/purchases/suppliers`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/purchases/suppliers`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/inventory/movements`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/inventory/movements`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
