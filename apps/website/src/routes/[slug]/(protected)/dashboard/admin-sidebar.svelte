<script lang="ts">
  ...
  const mainNavItems: NavItem[] = $derived([
    ...
    {
      title: "Checkout",
      href: `/${shop.slug}/dashboard/checkout`,
      icon: ScanBarcodeIcon,
    },
    {
      title: "Orders",
      href: `/${shop.slug}/dashboard/orders`,
      icon: ClipboardListIcon,
    },
    // {
    //   title: "Analytics",
    //   href: `/${shop.slug}/dashboard/analytics`,
    //   icon: ChartNoAxesCombinedIcon,
    // },
    {
      title: "Integrations",
      href: `/${shop.slug}/dashboard/integrations`,
      icon: LinkIcon,
    },
    // {
    //   title: "Notifications",
    //   href: `/${shop.slug}/dashboard/notifications`,
    //   icon: BellIcon,
    // },
  ]);
          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/dashboard/products`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/dashboard/products`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
            ...
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/dashboard/products/categories`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/dashboard/products/categories`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/dashboard/purchases/invoices`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/dashboard/purchases/invoices`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
            ...
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/dashboard/purchases/suppliers`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/dashboard/purchases/suppliers`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton
                ...
                isActive={isActive(`/${shop.slug}/dashboard/inventory/movements`)}
              >
                {#snippet child({ props })}
                  <a
                    href={`/${shop.slug}/dashboard/inventory/movements`}
                    {...props}
                    onclick={() => sidebar.isMobile && sidebar.setOpenMobile(false)}
                  >
