...
INSERT INTO `__new_purchase_invoice_item`(`id`, `purchase_invoice_id`, `product_id`, `invoice_item_name`, `qty`, `unit_cost_cents`, `line_subtotal_cents`, `vat_cents`, `discount_cents`, `freight_cents`, `line_total_cents`, `expiry_date`, `batch_number`, `created_at`) SELECT `id`, `purchase_invoice_id`, `product_id`, `invoice_item_name`, `qty`, `unit_cost_cents`, `line_subtotal_cents`, `vat_cents`, `discount_cents`, `freight_cents`, `line_total_cents`, `expiry_date`, `batch_number`, `created_at` FROM `purchase_invoice_item` WHERE `product_id` IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX `purchase_invoice_item_product_id_idx` ON `purchase_invoice_item` (`product_id`);
